      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className={`overflow-hidden border-none shadow-lg opacity-0 animate-fade-in animate-delay-${feature.delay}`}>
              <CardContent className="p-8 flex flex-col sm:flex-row items-start sm:items-center gap-6">
                <div className="rounded-full bg-medical-blue/10 p-4 text-medical-blue">
                  {feature.icon}
                </div>
                <div>
